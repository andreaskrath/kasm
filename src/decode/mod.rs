...
pub(super) fn decode(s: &str) -> Result<Instruction, DecodeError> {
...
#[cfg(test)]
mod regression {
    use crate::{decode::decode, error::DecodeError, instruction::Instruction};
    ...
    mod call_regression {
        use crate::{
            decode::decode, error::DecodeError, instruction::Instruction, operand::Operand,
            register::Register,
        };
